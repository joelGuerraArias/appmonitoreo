    ...
    try:
        ...
        for item in coincidencias_items:
            ...
            registro = {
                ...
                'nombre_medio': 'Medio de Comunicación',  # Se puede extraer del nombre del archivo
                'hora_programa': None,  # Se puede extraer del nombre del archivo
                'fecha_programa': None,  # Se puede extraer del nombre del archivo
                'url_video': url_video,  # URL de Cloudinary si está disponible
                'nombre_archivo': nombre_archivo,
                'enlace_directo': enlace_directo,  # Enlace directo si está disponible
